...
let EventsService = class EventsService {
    ...
    async getEvents(filterData) {
        ...
        try {
            ...
            const events = await query.getRawMany(); // here we bypassed the middle table so if we use getMany() we will lost the data of the middle table
