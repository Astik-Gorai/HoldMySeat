...
const common_1 = __webpack_require__(1);
const users_service_1 = __webpack_require__(11);
const user_register_dto_1 = __webpack_require__(15);
const user_login_dto_1 = __webpack_require__(16);
...
let UsersService = class UsersService {
    ...
    async loginUser(loginData) {
        try {
            ...
            const isMatch = await bcrypt.compare(actualPassword, loginData.password);
            if (!isMatch) {
